...
format: 
  revealjs:
    ...
    incremental: false
    footer: "Slides por [Artur Damião](https://arturdamiao.com), feito com [Quarto](https://quarto.org/docs/presentations/revealjs/index.html). Código disponível [no GitHub](https://github.com/beatrizmilz/2022-latinr-quarto-tutorial)."
    theme: simple
    slide-number: c/t
